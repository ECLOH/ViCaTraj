...
Le dossier "/R" contient tous les scripts R définissant nos fonctions. Entre autre la fonction "ViCaTraj()" qui permet à tous ceux qui ont installé le package de lancer l'appli. 
